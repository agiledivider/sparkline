...
class SvgRenderer
{
    ...
    public function addLine($path, $options = null)
    {
    ...
    public function addPercentShift($path, $options = null)
    {
    ...
    public function addDifference($pathMain, $pathCompare, $options = null)
    {
